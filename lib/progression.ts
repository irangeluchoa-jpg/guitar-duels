...
export const SPECIAL_TITLES: SpecialTitle[] = [
  ...
  {
    id: "getting_warm",
    label: "Aquecendo os Dedos",
    description: "10 músicas jogadas",
    icon: "🔥", color: "#f97316", rarity: "common",
    check: p => p.songsPlayed >= 10,
  },
  {
    id: "miss_machine",
    label: "Máquina de Erros",
    description: "Errou mais de 1000 notas (todo mundo começa assim!)",
    icon: "💀", color: "#6b7280", rarity: "common",
    check: p => p.totalMisses >= 1000,
  },
  {
    id: "combo_starter",
    label: "Bom de Combo",
    description: "Alcançou 50 de combo",
  ...
  },
  {
    id: "combo_god",
    label: "Deus do Combo",
    description: "Alcançou 500 de combo",
    icon: "⚡", color: "#a855f7", rarity: "epic",
    check: p => p.bestCombo >= 500,
  },
  {
    id: "first_fc",
    label: "Sem Errar Uma",
    description: "Primeiro Full Combo!",
  ...
  },
  {
    id: "untouchable",
    label: "Intocável",
    description: "25 Full Combos",
    icon: "🛡️", color: "#a855f7", rarity: "epic",
    check: p => p.fcCount >= 25,
  },
  {
    id: "fc_machine",
    label: "Máquina de FC",
    description: "50 Full Combos — você é inacreditável",
    icon: "🤖", color: "#f59e0b", rarity: "legendary",
    check: p => p.fcCount >= 50,
  },
  {
    id: "first_s",
    label: "Rank S",
    description: "Conquistou o primeiro rank S",
    icon: "⭐", color: "#fbbf24", rarity: "rare",
    check: p => p.sRankCount >= 1,
  },
  {
    id: "s_hunter",
  ...
  },
  {
    id: "s_addict",
    label: "Viciado em S+",
    description: "100 ranks S ou S+ — perfeição virou rotina",
    icon: "💫", color: "#f59e0b", rarity: "legendary",
    check: p => p.sRankCount >= 100,
  },
  {
    id: "veteran",
    label: "Veterano",
    description: "100 músicas jogadas",
  ...
  },
  {
    id: "legend",
    label: "Lenda",
    description: "500 músicas jogadas",
    icon: "🌟", color: "#f59e0b", rarity: "legendary",
  ...
  {
    id: "no_life",
    label: "Sem Vida Social",
    description: "100 horas de jogo — você é dedicado",
    icon: "⏰", color: "#ef4444", rarity: "epic",
    check: p => p.totalPlaytimeMs >= 100 * 3_600_000,
  },
  {
    id: "speed_demon",
    label: "Demônio da Velocidade",
    description: "20 músicas jogadas no modo Expert (6 lanes)",
  ...
  },
  {
    id: "easy_rider",
    label: "Sem Pressa",
    description: "50 músicas no modo Fácil (4 lanes)",
    icon: "🌊", color: "#3b82f6", rarity: "common",
    check: p => (p.songsPerDifficulty[4] ?? 0) >= 50,
  },
  {
    id: "high_scorer",
    label: "Pontuação Alta",
    description: "Score máximo acima de 500.000",
    icon: "📊", color: "#22c55e", rarity: "rare",
    check: p => p.bestScore >= 500_000,
  },
  {
    id: "million_man",
    label: "Milionário",
    description: "Score máximo acima de 1.000.000",
    icon: "💰", color: "#f59e0b", rarity: "epic",
    check: p => p.bestScore >= 1_000_000,
  },
  {
    id: "precise",
    label: "Cirurgião",
    description: "Mais de 10.000 notas perfeitas no total",
    icon: "🎯", color: "#22c55e", rarity: "rare",
    check: p => p.totalPerfects >= 10_000,
  },
  {
    id: "note_master",
    label: "Mestre das Notas",
    description: "100.000 notas perfeitas no total",
    icon: "🎼", color: "#a855f7", rarity: "epic",
    check: p => p.totalPerfects >= 100_000,
  },
  {
    id: "level_10",
    label: "Aprendiz",
  ...
  },
  {
    id: "centurion",
    label: "Centurião",
    description: "Atingiu o nível 100",
    icon: "🏛️", color: "#f59e0b", rarity: "legendary",
    check: p => p.level >= 100,
  },
  {
    id: "the_chosen_one",
    label: "O Escolhido",
    description: "Atingiu o nível 150",
    icon: "🔮", color: "#a855f7", rarity: "legendary",
    check: p => p.level >= 150,
  },
  {
    id: "supreme_lenda",
    label: "Lenda Suprema",
    description: "Nível máximo 200 — você transcendeu",
    icon: "✨", color: "#ff69b4", rarity: "legendary",
    check: p => p.level >= 200,
  },
  {
    id: "multi_killer",
    label: "Assassino do Multi",
    description: "XP total acima de 100.000",
    icon: "💥", color: "#ef4444", rarity: "rare",
    check: p => p.totalXP >= 100_000,
  },
  {
    id: "xp_hoarder",
    label: "Acumulador de XP",
    description: "XP total acima de 500.000",
    icon: "💎", color: "#f59e0b", rarity: "epic",
